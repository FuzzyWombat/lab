...
To Get Started make sure you have nodeJs18 or nodeJs20 installed in your devSehll 

```sh
ds tool install nodejs20
```
...
switch to the second terminal and run the command:
...
open another terminal (2nd or 3rd depending on boot sequence) and run the command:
```sh
npm run start:salt
```
